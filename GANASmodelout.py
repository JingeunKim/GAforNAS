...
make_dot(model(inputs), params=dict(model.named_parameters())).render(params_settings.model_name, format="png")

params = model.state_dict()
torch.onnx.export(model, inputs, params_settings.model_name+".onnx")
